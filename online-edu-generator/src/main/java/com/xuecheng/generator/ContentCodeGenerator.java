...
public class ContentCodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        gc.setFileOverride(true)
                //生成路径
                .setOutputDir(System.getProperty("user.dir") + "/xuecheng-plus-generator/src/main/java")
                .setAuthor("itcast")
                .setOpen(false)
                .setSwagger2(false)
        ...
        dsc.setDbType(DbType.MYSQL)
                .setUrl("jdbc:mysql://192.168.101.65:3306/xcplus_" + SERVICE_NAME
                        + "?serverTimezone=UTC&useUnicode=true&useSSL=false&characterEncoding=utf8")
                .setDriverName("com.mysql.cj.jdbc.Driver")
                .setUsername(DATA_SOURCE_USER_NAME)
