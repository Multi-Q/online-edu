...
public class Mp4VideoUtil extends VideoUtil {
    ...
    String video_path = "D:\\BaiduNetdiskDownload\\test1.avi"; //要转换的视频的所在路径
    String mp4_name = "test1.mp4"; //转换后的视频的名字
    String mp4folder_path = "D:/BaiduNetdiskDownload/Movies/test1/"; //转换成的MP4放到哪里文件路径下
